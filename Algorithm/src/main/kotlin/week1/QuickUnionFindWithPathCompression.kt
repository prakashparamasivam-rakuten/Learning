...
class QuickUnionFindWithPathCompression(N:Int): QuickUnionFind(N) {
...
fun main(args: Array<String>) {
    println("Hello World! QuickUnionFindWithPathCompression")
    val N:String? = readLine()
    val size = N?.toIntOrNull() ?: 0
    val uf = QuickUnionFindWithPathCompression(size)
    while (true){
        val input = readLine()
